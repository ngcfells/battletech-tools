...
var require_util = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var nameRegexp = "[" + nameStartChar + "][" + (nameStartChar + "\\-.\\d\\u00B7\\u0300-\\u036F\\u203F-\\u2040") + "]*";
	...
	*/
	exports.merge = function(target, a, arrayMode) {
		if (a) {
			...
			for (let i = 0; i < len; i++) if (arrayMode === "strict") target[keys[i]] = [a[keys[i]]];
...
var require_OptionsBuilder = /* @__PURE__ */ __commonJSMin(((exports) => {
...
var require_DocTypeReader = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var util = require_util();
	var DocTypeReader = class {
		...
		readElementExp(xmlData, i) {
			...
			if (!this.suppressValidationErr && !util.isName(elementName)) throw new Error(`Invalid element name: "${elementName}"`);
			i = skipWhitespace(xmlData, i);
			let contentModel = "";
...
var require_strnum = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function toNumber(str, options = {}) {
		...
		if (options.skipLike !== void 0 && options.skipLike.test(trimmedStr)) return str;
			...
			if (notation) {
				if (options.leadingZeros) trimmedStr = (notation[1] || "") + notation[3];
				else if (notation[2] === "0" && notation[3][0] === ".") {} else return str;
			...
			if (match) {
				...
				if (!options.leadingZeros && leadingZeros.length > 0 && sign && trimmedStr[2] !== ".") return str;
					...
					if (leadingZeros) return numTrimmedByZeros === numStr || sign + numTrimmedByZeros === numStr ? num : str;
					else return trimmedStr === numStr || trimmedStr === sign + numStr ? num : str;
				}
			} else return str;
		}
	}
...
var require_ignoreAttributes = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_OrderedObjParser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var util = require_util();
	...
	*/
	...
	function parseValue(val, shouldParse, options) {
		...
		} else if (util.isExist(val)) return val;
		else return "";
	}
	...
	function sanitizeName(name, options) {
		if (util.criticalProperties.includes(name)) throw new Error(`[SECURITY] Invalid name: "${name}" is a reserved JavaScript keyword that could cause prototype pollution`);
		else if (util.DANGEROUS_PROPERTY_NAMES.includes(name)) return options.onDangerousProperty(name);
		return name;
	}
...
var require_node2json = /* @__PURE__ */ __commonJSMin(((exports) => {
	/**
	* 
	* @param {array} node 
	* @param {any} options 
...
var require_XMLParser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/fast-xml-parser/src/xmlbuilder/orderedJs2Xml.js
var require_orderedJs2Xml = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EOL = "\n";
	/**
	* 
	* @param {array} jArray 
...
var require_fxp = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var validator = require_validator();
	module.exports = {
		XMLParser: require_XMLParser(),
		XMLValidator: validator,
		XMLBuilder: require_json2xml()
	};
}));
//#endregion
