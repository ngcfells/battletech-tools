import { IAbilitySource } from "./ability-source";
...
export const CONST_AS_SPECIAL_ABILITIES: IASSpecialAbility[] = [
    ...
    ***************************** */
    ...
    },
    {
        ...
        name: "Flak",
        summary: [
            "If a unit with this ability misses its Attack Roll by 2 points or less when attacking an airborne unit, or any unit that used VTOL, WiGE, or thrust movement this turn, the unit will deal damage to its target equal to its FLK rating at the appropriate range bracket.",
        ],
        source: { book: "ASCE", page: 78 },
        type: ESpecialAbilityType.Standard,
    },
    ...
    ***************************** */
    ...
    },
    {
        ...
        name: "Missile",
        summary: [
            "This unit mounts a significant number of missile launchers and may fire them together as an alternative weapon attack instead of a standard weapon attack. This ability enables the unit to use alternate missile ammunition for modified effects (see Alternate Munitions, p. 146)."
        ],
        source: { book: "ASCE", page: 87 },
        type: ESpecialAbilityType.Optional,
    },
    ...
    },
    {
        ...
        name: "Non-Open",
        summary: [
            "This special identifies a non-open, sealed unit."
        ],
        source: { book: "ASCE", page: 87 },
        type: ESpecialAbilityType.Optional
    },
    ...
    },
    {
        ...
        summary: [
            "TAG is used to paint a target with a laser to designate targets. A TAG- or LTAG-equipped unit can make a special weapon attack to designate a target. A TAG attack uses all appropriate rules for a standard weapon attack. LTAG works only at Short range, while TAG works at Short and Medium range. Designating a target is an additional attack that can be made in addition to any other weapon or physical attacks that same turn.",
            "A successfully designated target is spotted for indirect fire by the TAG-equipped unit, with no spotter attack modifier. In addition, a designated target can be attacked by semi-guided LRMs and homing artillery. If unsuccessful with a TAG designating attack, the target is still spotted for indirect fire, but adds the spotter attack modifier."
        ],
        source: { book: "ASCE", page: 90 },
        type: ESpecialAbilityType.Optional
    },
