...
},
{
    ...
    cost: 2,
    source: { book: "ASCE", page: 97 },
    summary: ["The unit uses a +1 attacker movement modifier for jumping instead of +2."],
},
...
},
{
    ...
    ability: "Sandblaster",
    cost: 2,
    source: { book: "ASCE", page: 99 },
    summary: ["When this unit makes a standard weapon attack and has one or more of the AC, FLK, IATM, LRM, SRM, or TOR specials, it delivers an additional 1 point of damage, increased to 2 points at Short range."],
},
{
    id: 42,
    ability: "Shaky Stick",
...
},
{
    ...
    cost: 2,
    source: { book: "ASCE", page: 100 },
    summary: ["1/2 move penalties & reduces heat/weather attack mods from high-temp environs."],
},
{
    id: 76,
    ability: "(Tundra Wolf)",
    cost: 2,
    source: { book: "ASCE", page: 100 },
    summary: ["1/2 move penalties/ice skids & reduces weather attack mods from freezing environs."],
},
{
    id: 77,
    ability: "(Spacefarer)",
    cost: 2,
    source: { book: "ASCE", page: 100 },
    summary: ["1/2 move penalties/pilot skill in zero-g, microgravity, or hard vacuum conditions."],
},
]
